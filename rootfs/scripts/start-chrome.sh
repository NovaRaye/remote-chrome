...
CHROME_CMD="/usr/bin/google-chrome-stable --no-sandbox --test-type --disable-dev-shm-usage --start-maximized --no-first-run --remote-debugging-port=19222 --user-data-dir=$CHROME_PROFILE_DIR --disable-gpu --disable-software-rasterizer --disable-3d-apis --disable-accelerated-2d-canvas --disable-accelerated-video-decode"
